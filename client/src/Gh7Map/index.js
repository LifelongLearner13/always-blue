...
class Gh7map extends Component {
   ...
   componentDidMount() {
		...
		window.map = L.map('map').setView([38.637584, -90.204644], 13);
				
		L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
			attribution: 'map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetmap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">mapbox</a>',
			maxZoom: 18,
			id: 'mapbox.streets',
			accessToken: 'pk.eyJ1Ijoia2FybGJlY2siLCJhIjoiY2puNnNtYXM2MHZjejNxbnZ3MmljYThsdiJ9.021TPbDGn37D-QxKP1INWA'
		}).addTo(window.map);
	...
	componentDidUpdate() {
   	...
   	updatemap(){   
		...
		var facilities = [
			...
			['SteppingIntoTheLight', 'yellow', -90.197739, 38.653897, 'Bosnian', 'medical'],
			...
			['BiddleHouse', 'green', -90.194751, 38.637700, 'Espanol', 'medical']           
		];		
       ...
       // console.log("cleared vector source");
		...
		facilities.forEach(function (facility) {
			...
			if(selectedLanguage===language){
				...
				L.geoJSON(geojsonFeature).addTo(window.map).bindPopup(function (layer) {
